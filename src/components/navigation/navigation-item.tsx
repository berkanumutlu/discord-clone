    ...
    return (
        <ActionTooltip side="right" align="center" label={name}>
            <button className="group relative flex items-center" onClick={onClick}>
                <div className={cn(
                    "absolute left-0 w-[4px] bg-primary rounded-r-full transation-all",
                ...
                <div className={cn(
                    ...
                    <Image src={imageUrl} alt="Channel" fill sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" />
                </div>
            </button>
        </ActionTooltip>
    )
